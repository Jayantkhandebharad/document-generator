...
class LLMClient:
    ...
    def generate(
        ...
        for attempt in range(retries):
            try:
                if self._provider == "gemini":
                    return self._generate_gemini(prompt, max_tokens, json_mode, temperature)
                else:
                    return self._generate_openai(prompt, max_tokens, json_mode, temperature)
    ...
    def _generate_openai(self, prompt, max_tokens, json_mode, temperature) -> str:
    ...
    def _generate_gemini(self, prompt, max_tokens, json_mode, temperature) -> str:
